...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><hr><p>执行 <code>yarn e2e</code> ，出现弹窗<br><img src="https://raw.gitmirror.com/levy9527/image-holder/main/docs/software-testing/1686494184473.png" alt="image.png"><br> 点击文件，即会执行用例。<br><img src="https://raw.gitmirror.com/levy9527/image-holder/main/docs/software-testing/1686494186469.png" alt="image.png"></p><h3 id="更复杂的示例" tabindex="-1"><a class="header-anchor" href="#更复杂的示例" aria-hidden="true">#</a> 更复杂的示例</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  beforeEach(() =&gt; {
    // 免登录
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="持续集成" tabindex="-1"><a class="header-anchor" href="#持续集成" aria-hidden="true">#</a> 持续集成</h2>`,13),N={href:"https://github.com/cypress-io/cypress-docker-images",target:"_blank",rel:"noopener noreferrer"},L=t(`<blockquote><p>注意自身的 Node 版本选择合适的镜像。</p></blockquote><p>另一方面，一般 CI 环境下执行的是 <code>cypress run</code> 命令。</p><blockquote><p>run 与 open 的不同之处在于，run 默认不会启动浏览器界面，使用的是 headless 模式执行用例。</p></blockquote><p>同时，需要安装 Cypress 时，需要设置环境变量 <code>CYPRESS_INSTALL_BINARY</code></p><p>最后，还是要强调一下，在生产安装依赖环节，使用如下命令安装依赖，则不会安装 Cypress 依赖</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>yarn --frozen-lockfile --production
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="直接运行-cypress" tabindex="-1"><a class="header-anchor" href="#直接运行-cypress" aria-hidden="true">#</a> 直接运行 Cypress</h3>`,7),D={href:"https://docs.gitlab.com/ee/ci/yaml/README.html#stages",target:"_blank",rel:"noopener noreferrer"},F=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>cypress:
  image:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>不推荐选择 <code>cypress/included</code> 镜像直接执行 Cypress 命令，因为很可能会遇到以下问题。<br> 当然，如果自己的用例写的不好，也很可能会出现下面的问题。<br><img src="https://raw.gitmirror.com/levy9527/image-holder/main/docs/software-testing/1686494188361.png" alt="image.png"></p><h3 id="使用-start-server-and-test" tabindex="-1"><a class="header-anchor" href="#使用-start-server-and-test" aria-hidden="true">#</a> 使用 start-server-and-test</h3><p>如果需要本地起个 localhost 服务，然后再运行 cypress。那么可以合作官方推荐的 <code>start-server-and-test</code> 模块。它在 CI 上的执行顺序是：</p><ol><li>在系统后台执行拉起本地服务的命令</li><li>使用 wait-on 模块监听并等待该本地服务响应 200</li><li>执行 test 命令，完成并退出</li><li>CI 环境此时会自动关闭所有后台进程并退出</li></ol>`,5),$={href:"http://gitlab.com/",target:"_blank",rel:"noopener noreferrer"},T=t(`<ul><li>package.json</li></ul><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="this-job-is-stuck" tabindex="-1"><a class="header-anchor" href="#this-job-is-stuck" aria-hidden="true">#</a> This job is stuck</h3><p><img src="https://raw.gitmirror.com/levy9527/image-holder/main/docs/software-testing/1686494190870.png" alt="image.png">如果是自建的 gitlab, 可能会遇到这个问题。<br> 这是任务没有打对标签，导致无法给任务分配对应的 Runner。<br><img src="https://raw.gitmirror.com/levy9527/image-holder/main/docs/software-testing/1686494192801.png" alt="image.png"><br> 进入上图所示页面，注意找到可使用的 Runner<br><img src="https://raw.gitmirror.com/levy9527/image-holder/main/docs/software-testing/1686494195056.png" alt="image.png"><br> 如上图所示， <code>docker</code> 标签对应的 Runner 是处于激活状态的，则在 CI 文件里配置即可</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>cypress:
  tags:
    - <span class="token function">docker</span>
